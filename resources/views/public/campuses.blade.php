...
<body class="bg-slate-50 text-slate-900 antialiased">
    ...
    <nav class="sticky top-0 z-50 border-b border-white/10 bg-black/50 text-white shadow-lg shadow-slate-950/10 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            <a href="{{ route('home') }}" class="flex items-center gap-3">
                <img src="/images/social/logo%20kampus%20media.png" alt="Kampus Media" width="160" height="48" decoding="async" class="h-12 w-auto object-contain [filter:drop-shadow(0_0_2px_rgba(255,255,255,1))_drop-shadow(0_0_5px_rgba(255,255,255,.72))]">
            </a>
    ...
    <footer class="border-t border-white/10 bg-navy/90 px-4 py-12 text-white shadow-2xl shadow-slate-950/20 backdrop-blur-xl sm:px-6 lg:px-8">
        <div class="mx-auto flex max-w-7xl flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
                <img src="/images/social/logo%20kampus%20media.png" alt="Kampus Media" loading="lazy" decoding="async" class="h-14 w-auto object-contain [filter:drop-shadow(0_0_2px_rgba(255,255,255,1))_drop-shadow(0_0_5px_rgba(255,255,255,.72))]">
            </div>
